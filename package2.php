...
<main>
    <!-- End Header -->
     ...
     <section id="packages" class="menu events">
        <div class="container-fluid tab-content tab-pane" data-aos="fade-up">
          ...
          <div class="tab-header text-center">
                  ...
                  <h3>Package 2</h3>
                    ...
                    <h5><strong>PAX GUARANTEED:</strong> 250</h5>
          ...
          >
            ...
            <li class="nav-item">
              <a
                class="nav-link"
                data-bs-toggle="tab"
                data-bs-target="#packages-packages3"
              >
                <h4>Venue</h4> </a
              ><!-- End tab nav item -->
            </li>
          ...
          <section>
            ...
            <!---- CHOOSE YOUR VENUE ----->
        <div class="tab-content">
          <div class="tab-pane fade" id="packages-packages3">
